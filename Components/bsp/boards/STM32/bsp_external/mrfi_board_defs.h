...
#define MRFI_GDO0_INT_VECTOR					EXTI0_IRQHandler
#define MRFI_GDO0_INT_HANDLER					EXTI0_IRQHandler
...
#define __mrfi_SPI_CSN_PIN__					PC4
#define __mrfi_SPI_CSN_GPIO_BIT__				( __mrfi_SPI_CSN_PIN__ & 0x0F )
#define __mrfi_SPI_CSN_GPIO_PORT__				GPIOC
...
/* CSn-B Pin Configuration */
#define __mrfi_SPI_CSN_B_PIN__					PC5
#define __mrfi_SPI_CSN_B_GPIO_BIT__				( __mrfi_SPI_CSN_B_PIN__ & 0x0F )
#define __mrfi_SPI_CSN_B_GPIO_PORT__				GPIOC
#define __mrfi_SPI_CSN_B_GPIO_DDR__
#define MRFI_SPI_CONFIG_CSN_B_PIN_AS_OUTPUT()		__mrfi_SPI_CSN_B_GPIO_PORT__->BSRR = BV(__mrfi_SPI_CSN_B_GPIO_BIT__);	\
													__bsp_PIN_CONFIG__	( __mrfi_SPI_CSN_B_PIN__,  PIN_MODE_OUT_PP_50 )
